      ...
      rejectedRequests?.forEach(req => {
        if (req.quotation_items) {
          ...
          processedItems.push({
            ...
            cost_amount_input: req.cost_amount ?? ((req.quotation_items.cost !== null && req.quotation_items.cost !== undefined) ? req.quotation_items.cost : 0),
            original_cost: req.cost_amount ?? ((req.quotation_items.cost !== null && req.quotation_items.cost !== undefined) ? req.quotation_items.cost : 0),
