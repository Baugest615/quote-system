-- Fix get_available_pending_payments function to include client information
-- This resolves the "Unknown Client" issue in the pending payments list
...
COMMENT ON FUNCTION get_available_pending_payments() IS '取得可用於請款的報價項目（已簽約且未請款的項目），包含客戶資訊';
